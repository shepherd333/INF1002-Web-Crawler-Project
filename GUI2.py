...
b2= tk.Button(main, text='Median Car Prices by Year', font=labelfont,bg='white', command=year, width=30)
b2.pack(padx=5,pady=10)
b3= tk.Button(main,text='Median Car Prices by Brand', font=labelfont, bg='white',command=brand, width=30)
b3.pack(padx=5,pady=10)
b4= tk.Button(main,text='Vehicle Depreciation', font=labelfont,bg='white', command=depreciation, width=30)
b4.pack(padx=5,pady=10)
b5= tk.Button(main,text='Average COE Price', font=labelfont,bg='white', command=average_coe, width=30)
...
b9= tk.Button(main,text='Median Price by Brand with 100 or more listings', font=labelfont,bg='white', command=medianprice, width=35)
